        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={6} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Ecommerce"
              description="The e-commerce website, crafted with HTML, CSS, and JavaScript, is a dynamic platform that seamlessly blends front-end technologies to deliver an engaging shopping experience. HTML forms the structural backbone, while CSS ensures consistent and visually appealing presentation. JavaScript drives interactivity, enabling dynamic content generation such as product listings based on user interactions and data retrieval. Responsive design principles further enhance accessibility across devices, 
              ensuring a seamless experience for users. This amalgamation of technologies results in an intuitive and efficient online shopping destination, adept at meeting the evolving needs of modern consumers."
